...
class Administrators extends CI_Controller{
    ...
    */
    ...
    public function index(){
        $data['pageContent'] = $this->load->view('admin', '', TRUE);
    ...
    */
    ...
    public function laad_(){
        ...
        $data['range'] = ($start+1) . "-" . ($start + count($data['allAdministrators'])) . " of " . $totalAdministrators;
        $data['links'] = $this->pagination->create_links();//page links
        $data['sn'] = $start+1;
        
        $json['adminTable'] = $this->load->view('adminlist', $data, TRUE);//get view with populated customers table
